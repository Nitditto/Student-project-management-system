      ...
      <div className="space-y-6">
        <div className="card">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-4 pt-4 border-t border-slate-200" type="submit">
              <button type="submit" className="btn btn-primary disabled:opacity-50" disabled={isLoading}>
